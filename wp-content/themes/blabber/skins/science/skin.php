        ...
        $schemes = array(
            ...
            'default' => array(
                ...
                'colors'   => array(
                    ...
                    'alter_bg_hover'   => '#E7E8ED', // ok
                    'alter_bd_color'   => '#E0E0E0', //
                    'alter_bd_hover'   => '#606060', //
                    'alter_text'       => '#191919', //
                    'alter_light'      => '#939393', //
                    'alter_dark'       => '#191919', //
                    'alter_link'       => '#FA6732', // ok
                    'alter_hover'      => '#161616', //
                    'alter_link2'      => '#8be77c',
                    'alter_hover2'     => '#80d572',
                    'alter_link3'      => '#eec432',
            ...
            'dark'    => array(
                ...
                'colors'   => array(
                    ...
                    'alter_link'       => '#ffffff', // FA6732
                    'alter_hover'      => '#FA6732', // ffffff
                    'alter_link2'      => '#8be77c',
                    'alter_hover2'     => '#80d572',
                    'alter_link3'      => '#eec432',
                    'alter_hover3'     => '#ddb837',
...
if ( ! function_exists( 'blabber_skin_importer_set_options' ) ) {
	...
	function blabber_skin_importer_set_options($options = array()) {
		if ( is_array( $options ) ) {
			$options['demo_type'] = 'science';
			$options['files']['science'] = $options['files']['default'];
			$options['files']['science']['title'] = esc_html__('Science Demo', 'blabber');
			$options['files']['science']['domain_dev'] = '';    // Developers domain
			$options['files']['science']['domain_demo'] = esc_url( blabber_get_protocol() . '://science.blabber.ancorathemes.com' );   // Demo-site domain
