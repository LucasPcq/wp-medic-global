...
if ( ! function_exists( 'blabber_skin_get_css' ) ) {
    ...
    .nav-links, .page_links, body .mejs-container *, blockquote,
...
CSS;
   ...
   .search_wrap.search_style_expand .search_submit:hover:before {
    ...
    .related_wrap.related_style_classic .post_header .post_meta .post_meta_item span {
        color: {$colors['text_link']};
    }
    .related_wrap.related_style_classic .post_header .post_meta .post_meta_item:hover span,
    .related_wrap.related_style_classic .post_header .post_meta a.post_meta_item:hover {
        color: {$colors['text_dark']};
    }
    
    .related_wrap.related_style_classic .related_content_wrap{
        background-color: {$colors['inverse_bd_color']};
    }
