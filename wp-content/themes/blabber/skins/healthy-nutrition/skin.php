        ...
        blabber_storage_set(
            'load_fonts', array(
                ...
                array(
                    ...
                    'family' => 'sans-serif',
                    'styles' => '200,200i,300,300i,400,400i,600,600i,700,700i,900,900i'     // Parameter 'style' used only for the Google fonts
                ),
                array(
                    'name'   => 'Lora',
                    'family' => 'serif',
        ...
        $schemes = array(
            ...
            'default' => array(
                ...
                'colors'   => array(
                    ...
                    'alter_bg_color'   => '#EAE9E5', //+
                    'alter_bg_hover'   => '#ffffff', //+
                    'alter_bd_color'   => '#A0928A', //+
                    'alter_bd_hover'   => '#A0928A', //+
                    'alter_text'       => '#48403C', //+
                    'alter_light'      => '#A0928A', //+
                    'alter_dark'       => '#392B24', //+
                    'alter_link'       => '#F36A46', //+
            ...
            'dark'    => array(
                ...
                'colors'   => array(
                    ...
                    // Input fields (form's fields and textarea)
                    'input_bg_color'   => '#56463e', //+
                    'input_bg_hover'   => '#56463e', //+
                    'input_bd_color'   => '#56463e', //+
                    'input_bd_hover'   => '#56463e', //
                    'input_text'       => '#8B8B8B', //
                    'input_light'      => '#7B7B7B', //
                    'input_dark'       => '#ffffff', //+

                    // Inverse blocks (text and links on the 'text_link' background)
                    'inverse_bd_color' => '#241F1D',//+
                    'inverse_bd_hover' => '#392B24',//
                    'inverse_text'     => '#A0928A',//+
...
if ( ! function_exists( 'blabber_skin_importer_set_options' ) ) {
	...
	function blabber_skin_importer_set_options($options = array()) {
		if ( is_array( $options ) ) {
			$options['demo_type'] = 'healthy-nutrition';
			$options['files']['healthy-nutrition'] = $options['files']['default'];
			$options['files']['healthy-nutrition']['title'] = esc_html__('Food Demo', 'blabber');
			$options['files']['healthy-nutrition']['domain_dev'] = '';    // Developers domain
			$options['files']['healthy-nutrition']['domain_demo'] = esc_url( blabber_get_protocol() . '://healthy-nutrition.blabber.ancorathemes.com' );   // Demo-site domain
