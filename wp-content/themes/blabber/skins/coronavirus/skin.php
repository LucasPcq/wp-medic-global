<?php
/**
 * Skins support: Main skin file for the skin 'Coronavirus'
 *
        ...
        blabber_storage_set(
            'load_fonts', array(
                ...
                array(
                    'name'   => 'Open Sans',
                    'family' => 'sans-serif',
                    'styles' => '300,300i,400,400i,500,500i,600,600i,700,700i,900,900i',     // Parameter 'style' used only for the Google fonts
                ),
				array(
                    'name'   => 'Roboto Slab',
                    'family' => 'sans-serif',
                    'styles' => '200,300,400,500,600,700,800',     // Parameter 'style' used only for the Google fonts
                ),
            )
        );
        ...
        $schemes = array(
            ...
            'default' => array(
                ...
                'colors'   => array(
                    ...
                    'text_dark'        => '#161616', //ok
                    'text_link'        => '#E12502', //ok
                    'text_hover'       => '#1A1A1A', //ok
                    'text_link2'       => '#E12502', //done
                    'text_hover2'      => '#8be77c',
                    'text_link3'       => '#E4FAF9', //ok
                    'text_hover3'      => '#eec432',

                    // Alternative blocks (sidebar, tabs, alternative blocks, etc.)
                    'alter_bg_color'   => '#F3F3F3', //done
                    'alter_bg_hover'   => '#E6E6E6', //
                    'alter_bd_color'   => '#F3F3F3', //done
                    'alter_bd_hover'   => '#606060', //
                    'alter_text'       => '#191919', //
                    'alter_light'      => '#939393', //done
                    'alter_dark'       => '#1A1A1A', // ok
                    'alter_link'       => '#E12502', //done
                    'alter_hover'      => '#161616', //
                    'alter_link2'      => '#8be77c',
                    'alter_hover2'     => '#80d572',
                    'alter_link3'      => '#E4FAF9', //ok
                    'alter_hover3'     => '#ddb837',
                    ...
                    'extra_text'       => '#939393', //done
                    'extra_light'      => '#afafaf',
                    'extra_dark'       => '#ffffff', //
                    'extra_link'       => '#E12502', //done
                    'extra_hover'      => '#ffffff', // ?
                    'extra_link2'      => '#E12502', //done
                    'extra_hover2'     => '#161616', //done
                    'extra_link3'      => '#ddb837',
                    'extra_hover3'     => '#eec432',
                    ...
                    'input_bd_color'   => '#F3F3F3', //done
                    'input_bd_hover'   => '#161616', //ok
                    'input_text'       => '#535353', //done
                    'input_light'      => '#939393', //done
                    'input_dark'       => '#161616', //done
            ...
            'dark'    => array(
                ...
                'colors'   => array(
                    ...
                    // Whole block border and background
                    'bg_color'         => '#1A1A1A', // for alter_bg_color
                    'bd_color'         => '#2B2B2B', //
...
if ( ! function_exists( 'blabber_skin_importer_set_options' ) ) {
	...
	function blabber_skin_importer_set_options($options = array()) {
		if ( is_array( $options ) ) {
			$options['demo_type'] = 'coronavirus';
			$options['files']['coronavirus'] = $options['files']['default'];
			$options['files']['coronavirus']['title'] = esc_html__('Coronavirus  News Demo', 'blabber');
			$options['files']['coronavirus']['domain_dev'] = '';    // Developers domain
			$options['files']['coronavirus']['domain_demo'] = esc_url( blabber_get_protocol() . '://coronavirus.blabber.ancorathemes.com' );   // Demo-site domain
