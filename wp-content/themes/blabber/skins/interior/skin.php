        ...
        blabber_storage_set(
            'load_fonts', array(
                ...
                array(
                    ...
                    'family' => 'sans-serif',
                    'styles' => 'Red+Hat+Display:400,400i,500,500i,700,700i,900,900i',     // Parameter 'style' used only for the Google fonts
                ),
				array(
                    'name'   => 'Red Hat Text',
                    'family' => 'sans-serif',
                    'styles' => 'Red+Hat+Text:400,400i,500,500i,700,700i',     // Parameter 'style' used only for the Google fonts
                )
            )
        );
        ...
        $schemes = array(
            ...
            'default' => array(
                ...
                'colors'   => array(
                    ...
                    'alter_bg_color'   => '#F3EBEB', // ok
                    'alter_bg_hover'   => '#ECE7E7', //
                    'alter_bd_color'   => '#C6C5C5', //
                    'alter_bd_hover'   => '#606060', //
                    'alter_text'       => '#191919', //
                    'alter_light'      => '#939393', //
                    'alter_dark'       => '#191919', //
                    'alter_link'       => '#CF988B', // ok
                    'alter_hover'      => '#161616', //
                    'alter_link2'      => '#8be77c',
                    'alter_hover2'     => '#80d572',
                    'alter_link3'      => '#eec432',
            ...
            'dark'    => array(
                ...
                'colors'   => array(
                    ...
                    // Whole block border and background
                    'bg_color'         => '#1E1E1E', // for alter_bg_color
                    'bd_color'         => '#2B2B2B', //
                    ...
                    // Alternative blocks (sidebar, tabs, alternative blocks, etc.)
                    'alter_bg_color'   => '#2d2d2d', // for bg_color
...
if ( ! function_exists( 'blabber_skin_importer_set_options' ) ) {
	...
	function blabber_skin_importer_set_options($options = array()) {
		if ( is_array( $options ) ) {
			$options['demo_type'] = 'interior';
			$options['files']['interior'] = $options['files']['default'];
			$options['files']['interior']['title'] = esc_html__('Interior Demo', 'blabber');
			$options['files']['interior']['domain_dev'] = '';    // Developers domain
			$options['files']['interior']['domain_demo'] = esc_url( blabber_get_protocol() . '://interior.blabber.ancorathemes.com' );   // Demo-site domain
