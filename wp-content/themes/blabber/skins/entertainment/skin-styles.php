...
if ( ! function_exists( 'blabber_skin_get_css' ) ) {
    ...
    .search_style_expand input[placeholder]::-webkit-input-placeholder{ {$fonts['button_font-family']} {$fonts['button_font-weight']} {$fonts['button_font-size']} {$fonts['button_text-transform']} }
    .search_style_expand input[placeholder]::-moz-placeholder { {$fonts['button_font-family']} {$fonts['button_font-weight']} {$fonts['button_font-size']} {$fonts['button_text-transform']} }
    .search_style_expand input[placeholder]:-ms-input-placeholder { {$fonts['button_font-family']} {$fonts['button_font-weight']} {$fonts['button_font-size']} {$fonts['button_text-transform']} }
    .search_style_expand input[placeholder]::placeholder { {$fonts['button_font-family']} {$fonts['button_font-weight']} {$fonts['button_font-size']} {$fonts['button_text-transform']} }
