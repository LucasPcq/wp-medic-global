        ...
        blabber_storage_set(
            'theme_fonts', array(
                ...
                'info'    => array(
					...
					'font-family'     => '"SinkinSans",sans-serif',
                    'font-size'       => '10px',  // Old value '13px' don't allow using 'font zoom' in the custom blog items
                    'font-weight'     => '400',
                    'font-style'      => 'normal',
                    'line-height'     => '1.2em',
                    'text-decoration' => 'none',
        ...
        $schemes = array(
            ...
            'dark'    => array(
                ...
                'colors'   => array(
                    ...
                    // Alternative blocks (sidebar, tabs, alternative blocks, etc.)
                    'alter_bg_color'   => '#242424', // for bg_color
                    'alter_bg_hover'   => '#383737',
                    'alter_bd_color'   => '#848484', //
                    ...
                    // Extra blocks (submenu, tabs, color blocks, etc.)
                    'extra_bg_color'   => '#242424', //
                    'extra_bg_hover'   => '#848484', // ?
                    'extra_bd_color'   => '#848484', // ?
                    ...
                    'input_bg_hover'   => '#242424', //
                    'input_bd_color'   => '#848484', //
...
if ( ! function_exists( 'blabber_skin_importer_set_options' ) ) {
	...
	function blabber_skin_importer_set_options($options = array()) {
		if ( is_array( $options ) ) {
			$options['demo_type'] = 'entertainment';
			$options['files']['entertainment'] = $options['files']['default'];
			$options['files']['entertainment']['title'] = esc_html__('Entertainment Demo', 'blabber');
			$options['files']['entertainment']['domain_dev'] = '';    // Developers domain
			$options['files']['entertainment']['domain_demo'] = esc_url( blabber_get_protocol() . '://entertainment.blabber.ancorathemes.com' );   // Demo-site domain
