...
CSS;
    ...
    .scheme_self .sc_layouts_row.sc_layouts_row_type_narrow a,
    .scheme_self.sc_layouts_row.sc_layouts_row_type_narrow a {
        color: {$colors['inverse_dark']}!important;
    }
    .scheme_self .sc_layouts_row.sc_layouts_row_type_narrow a:hover,
    .scheme_self.sc_layouts_row.sc_layouts_row_type_narrow a:hover {
        color: {$colors['text_link']}!important;
    }
    .scheme_self .sc_layouts_row.sc_layouts_row_type_narrow li li a,
    .scheme_self.sc_layouts_row.sc_layouts_row_type_narrow li li a {
        color: {$colors['text_dark']}!important;
    }
    .scheme_self .sc_layouts_row.sc_layouts_row_type_narrow li li a:hover,
    .scheme_self.sc_layouts_row.sc_layouts_row_type_narrow li li a:hover {
        color: {$colors['text_link']}!important;
    }
    ...
    .top_panel_custom .sc_layouts_row_type_compact .search_wrap.search_style_fullscreen:not(.search_opened) .search_submit:hover {
        background-color: {$colors['text_link2']} !important;
        color: {$colors['inverse_dark']}!important;
    }
    figure figcaption,
