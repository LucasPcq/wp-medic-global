<?php
/**
 * Skins support: Main skin file for the skin 'Sports News'
 *
        ...
        blabber_storage_set(
            'load_fonts', array(
                ...
                array(
                    'name'   => 'Oswald',
                    'family' => 'sans-serif',
                    'styles' => '200,300,400,500,600,700',     // Parameter 'style' used only for the Google fonts
                ),
				array(
                    'name'   => 'Roboto',
                    'family' => 'sans-serif',
                    'styles' => '100,100i,300,300i,400,400i,500,500i,700,700i,900',     // Parameter 'style' used only for the Google fonts
                ),
            )
        );
        ...
        $schemes = array(
            ...
            'default' => array(
                ...
                'colors'   => array(
                    ...
                    'text'             => '#535353', //done
                    'text_light'       => '#939393', //done
                    'text_dark'        => '#161616', //done
                    'text_link'        => '#ED213A', //done
                    'text_hover'       => '#535353', //done
                    'text_link2'       => '#FEBC04', //done
                    'text_hover2'      => '#8be77c',
                    'text_link3'       => '#ddb837',
                    'text_hover3'      => '#eec432',
                    ...
                    'extra_light'      => '#afafaf',
                    'extra_dark'       => '#ffffff', //
                    'extra_link'       => '#ED213A', //done
                    'extra_hover'      => '#ffffff', // ?
                    'extra_link2'      => '#ED213A', //done
...
if ( ! function_exists( 'blabber_skin_importer_set_options' ) ) {
	...
	function blabber_skin_importer_set_options($options = array()) {
		if ( is_array( $options ) ) {
			$options['demo_type'] = 'sports-news';
			$options['files']['sports-news'] = $options['files']['default'];
			$options['files']['sports-news']['title'] = esc_html__('Sports News Demo', 'blabber');
			$options['files']['sports-news']['domain_dev'] = '';    // Developers domain
			$options['files']['sports-news']['domain_demo'] = esc_url( blabber_get_protocol() . '://sports.blabber.ancorathemes.com' );   // Demo-site domain
