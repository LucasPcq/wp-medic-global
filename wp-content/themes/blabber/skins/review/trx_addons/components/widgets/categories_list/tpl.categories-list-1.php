            ...
            foreach ($categories as $cat) {
                ...
                <div class="categories_list_item">
                    ...
                    if ($show_thumbs) {
                        ...
                        $icon = '';
                        if ( empty($image) ) {
                            $icon = blabber_get_term_icon($cat->term_id, $cat->taxonomy);
                        ...
                        if ( !empty($icon) && !trx_addons_is_off($icon) ) {
                            ...
                            ?><img src="<?php echo esc_url($src); ?>" <?php if (!empty($attr[3])) trx_addons_show_layout($attr[3]); ?> alt="<?php esc_attr_e('Category image', 'blabber'); ?>"><?php
                        }
                        ?></div><?php
                    }
