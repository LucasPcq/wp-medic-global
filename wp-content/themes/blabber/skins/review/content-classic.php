...
$date_val2 = 'rating';
$pos2 = strpos($blabber_components, $date_val2);
...
>
	...
	if ( ! in_array( $blabber_post_format, array( 'link', 'aside', 'status', 'quote' ) ) ) {
		...
		<div class="post_header entry-header">
			<?php
            if ( $pos !== false && get_post_type() != 'page') {
            ...
            $vowels = array(",categories", "categories,", "categories",",rating", "rating,", "rating" );
    ...
    <?php
            ...
            if($template_out) {
                ...
                <div class="post_content entry-content">
                   <?php  blabber_show_layout($template_out); ?>
