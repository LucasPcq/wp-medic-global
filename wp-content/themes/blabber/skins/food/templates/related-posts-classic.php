...
?><div id="post-<?php the_ID(); ?>" <?php post_class( 'related_item post_format_' . esc_attr( $blabber_post_format ) ); ?>><a class="related_link_wrap" href="<?php echo esc_url( $blabber_link ); ?>"></a>
	<?php
