<?php
/**
 * Skins support: Startup skin file for the skin 'Default'
 *
        ...
        blabber_storage_set(
            'load_fonts', array(
                ...
                array(
                    'name'   => 'Heebo',
                    'family' => 'sans-serif',
                    'styles' => '100,300,400,500,700,800,900',     // Parameter 'style' used only for the Google fonts
                ),
            )
        );
        ...
        $schemes = array(
            ...
            'default' => array(
                ...
                'colors'   => array(
                    ...
                    'text'             => '#707070', //ok
                    'text_light'       => '#989898', //ok
                    'text_dark'        => '#161616', //ok
                    'text_link'        => '#FE1E1D', //ok
                    'text_hover'       => '#161616', //ok
                    'text_link2'       => '#E6E6E6',// new
                    'text_hover2'      => '#8be77c',
                    'text_link3'       => '#409108 ',
                    'text_hover3'      => '#eec432',
                    ...
                    'alter_bd_color'   => '#E8E8E8', //ok
                    'alter_bd_hover'   => '#606060', //ok
                    'alter_text'       => '#161616', //ok
                    'alter_light'      => '#989898', //ok
                    'alter_dark'       => '#161616', //ok
                    'alter_link'       => '#FE1E1D', //ok
                    'alter_hover'      => '#161616', //ok
                    'alter_link2'      => '#E6E6E6', //new
                    'alter_hover2'     => '#80d572',
                    'alter_link3'      => '#409108 ', //new
                    'alter_hover3'     => '#ddb837',

                    // Extra blocks (submenu, tabs, color blocks, etc.)
                    'extra_bg_color'   => '#292C34', //ok
                    'extra_bg_hover'   => '#2B2B2B', //ok
                    'extra_bd_color'   => '#2B2B2B', //ok
                    'extra_bd_hover'   => '#3d3d3d',
                    'extra_text'       => '#989898', //ok
                    'extra_light'      => '#afafaf',
                    'extra_dark'       => '#ffffff', //ok
                    'extra_link'       => '#FE1E1D', //ok ?
                    ...
                    'input_bg_color'   => '#EFEFEF', //ok
                    'input_bg_hover'   => '#EFEFEF', //ok
                    'input_bd_color'   => '#EFEFEF', //ok
                    'input_bd_hover'   => '#989898', //ok
                    'input_text'       => '#989898', //ok
                    'input_light'      => '#989898', //ok
            ...
            'dark'    => array(
                ...
                'colors'   => array(
                    ...
                    // Whole block border and background
                    'bg_color'         => '#292C34', //ok for alter_bg_color
                    'bd_color'         => '#494a4d', //ok
                    ...
                    'text_link2'       => '#222429', //new
                    'text_hover2'      => '#8be77c',
                    'text_link3'       => '#ddb837',
                    'text_hover3'      => '#eec432',

                    // Alternative blocks (sidebar, tabs, alternative blocks, etc.)
                    'alter_bg_color'   => '#222429', //ok for bg_color
                    'alter_bg_hover'   => '#383737',
                    'alter_bd_color'   => '#292C34', //ok
                    'alter_bd_hover'   => '#575757', //ok
                    'alter_text'       => '#989898', //ok
                    'alter_light'      => '#989898', //ok
                    'alter_dark'       => '#ffffff', //ok
                    'alter_link'       => '#FE1E1D', //ok
                    'alter_hover'      => '#ffffff', //ok
                    'alter_link2'      => '#292C34', //new
                    'alter_hover2'     => '#80d572',
                    'alter_link3'      => '#409108 ', //new
                    'alter_hover3'     => '#ddb837',
                    ...
                    // Input fields (form's fields and textarea)
                    'input_bg_color'   => '#222429', //ok
                    'input_bg_hover'   => '#222429', //ok
                    'input_bd_color'   => '#222429', //ok
                    'input_bd_hover'   => '#575757', //ok
                    'input_text'       => '#989898', //ok
                    'input_light'      => '#989898', //ok
...
if ( ! function_exists( 'blabber_skin_importer_set_options' ) ) {
	...
	function blabber_skin_importer_set_options($options = array()) {
		if ( is_array( $options ) ) {
			$options['demo_type'] = 'startup';
			$options['files']['startup'] = $options['files']['default'];
			$options['files']['startup']['title'] = esc_html__('Startup Demo', 'blabber');
			$options['files']['startup']['domain_dev'] = '';    // Developers domain
			$options['files']['startup']['domain_demo'] = esc_url( blabber_get_protocol() . '://startup.blabber.ancorathemes.com' );   // Demo-site domain
