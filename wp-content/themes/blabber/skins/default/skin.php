        ...
        $schemes = array(
            ...
            'default' => array(
                ...
                'colors'   => array(
                    ...
                    'alter_text'       => '#191919', //ok
                    'alter_light'      => '#939393', //ok
                    'alter_dark'       => '#191919', //ok
                    'alter_link'       => '#219FFF', //ok
            ...
            'dark'    => array(
                ...
                'colors'   => array(
                    ...
                    // Input fields (form's fields and textarea)
                    'input_bg_color'   => '#232323', //ok
                    'input_bg_hover'   => '#232323', //ok
                    'input_bd_color'   => '#3A3A3A', //ok
                    'input_bd_hover'   => '#575757', //ok
                    'input_text'       => '#7B7B7B', //ok
...
if ( false && ! function_exists( 'blabber_skin_importer_set_options' ) ) {
	...
	function blabber_skin_importer_set_options($options = array()) {
		if ( is_array( $options ) ) {
			...
			$options['files']['skin_slug']['title'] = esc_html__('Skin Title Demo', 'blabber');
			$options['files']['skin_slug']['domain_dev'] = esc_url( blabber_get_protocol() . '://skin_slug.theme_slug.themerex.dnw' );    // Developers domain
			$options['files']['skin_slug']['domain_demo'] = esc_url( blabber_get_protocol() . '://skin_slug.theme_slug.themerex.net' );   // Demo-site domain
