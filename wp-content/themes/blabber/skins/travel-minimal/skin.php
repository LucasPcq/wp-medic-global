<?php
/**
 * Skins support: Travel Minimal skin file for the skin 'Default'
 *
        ...
        $schemes = array(
            ...
            'default' => array(
                ...
                'colors'   => array(
                    ...
                    'text'             => '#707070', // ok
                    'text_light'       => '#A4A4A4', // ok
                    'text_dark'        => '#161616', // ok
                    'text_link'        => '#1EABE4', // ok
                    'text_hover'       => '#182031', // ok
                    'text_link2'       => '#80d572',
                    'text_hover2'      => '#8be77c',
                    'text_link3'       => '#ddb837',
                    'text_hover3'      => '#eec432',
            ...
            'dark'    => array(
                ...
                'colors'   => array(
                    ...
                    // Whole block border and background
                    'bg_color'         => '#182031', // for alter_bg_color
                    'bd_color'         => '#2B2B2B', //
                    ...
                    // Alternative blocks (sidebar, tabs, alternative blocks, etc.)
                    'alter_bg_color'   => '#1E293A', // for bg_color
                    ...
                    // Input fields (form's fields and textarea)
                    'input_bg_color'   => '#1E293A', //
                    'input_bg_hover'   => '#1E293A', //
...
if ( ! function_exists( 'blabber_skin_importer_set_options' ) ) {
	...
	function blabber_skin_importer_set_options($options = array()) {
		if ( is_array( $options ) ) {
			$options['demo_type'] = 'travel-minimal';
			$options['files']['travel-minimal'] = $options['files']['default'];
			$options['files']['travel-minimal']['title'] = esc_html__('Travel Minimal Demo', 'blabber');
			$options['files']['travel-minimal']['domain_dev'] = '';    // Developers domain
			$options['files']['travel-minimal']['domain_demo'] = esc_url( blabber_get_protocol() . '://travel-minimal.blabber.ancorathemes.com' );   // Demo-site domain
...
if ( ! function_exists( 'blabber_trx_addons_sc_list_skin' ) ) {
    function blabber_trx_addons_sc_list_skin( $list = array() ) {
		...
		$list['blogger']['templates']['default']['over_ex_bottom'] = array(
			'title' => __('Info over image (bottom + des)', 'blabber'),
			'layout' => array(
				'featured' => array(
					'bl' => array(
						'title', 'excerpt', 'meta'
		...
		$list['blogger']['templates']['news']['announce'] = array(
			'title' => __('Announce', 'blabber'),
			'grid'  => array(
				// One post
				array(
					'grid-layout' => array(
						array(
							'template' => 'default/over_ex_bottom',
							'args' => array( 'image_ratio' => '1:1', 'columns' => 1 )
						),
					)
				),
				// Two posts
