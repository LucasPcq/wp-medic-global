<?php
/**
 * Skins support: Minimal skin file for the skin 'Default'
 *
		...
		$schemes = array(
			...
			'default' => array(
				...
				'colors'   => array(
					...
					'text_link'        => '#09A729', // ok
					'text_hover'       => '#161616', //
					'text_link2'       => '#09A729', // ok
					'text_hover2'      => '#444444', // ok
					'text_link3'       => '#ddb837',
					'text_hover3'      => '#eec432',

					// Alternative blocks (sidebar, tabs, alternative blocks, etc.)
					'alter_bg_color'   => '#E6E6E6', //
			...
			'dark'    => array(
				...
				'colors'   => array(
					...
					'text_hover'       => '#ffffff', //
					'text_link2'       => '#09A729', // ok
					'text_hover2'      => '#c8c3c3', // ok
					'text_link3'       => '#ddb837',
					'text_hover3'      => '#eec432',

					// Alternative blocks (sidebar, tabs, alternative blocks, etc.)
					'alter_bg_color'   => '#232323', //
...
if ( ! function_exists( 'blabber_skin_importer_set_options' ) ) {
	...
	function blabber_skin_importer_set_options($options = array()) {
		if ( is_array( $options ) ) {
			$options['demo_type'] = 'minimal';
			$options['files']['minimal'] = $options['files']['default'];
			$options['files']['minimal']['title'] = esc_html__('Traveler Demo', 'blabber');
			$options['files']['minimal']['domain_dev'] = '';    // Developers domain
			$options['files']['minimal']['domain_demo'] = esc_url( blabber_get_protocol() . '://minimal.blabber.ancorathemes.com' );   // Demo-site domain
