...
if ( ! function_exists( 'blabber_gutenberg_add_theme_vars' ) ) {
	add_filter( 'blabber_filter_add_theme_vars', 'blabber_gutenberg_add_theme_vars', 10, 2 );
	function blabber_gutenberg_add_theme_vars( $rez, $vars ) {
		return $rez;
	}
}
...
if ( ! function_exists( 'blabber_gutenberg_get_css' ) ) {
	add_filter( 'blabber_filter_get_css', 'blabber_gutenberg_get_css', 10, 2 );
	function blabber_gutenberg_get_css( $css, $args ) {
