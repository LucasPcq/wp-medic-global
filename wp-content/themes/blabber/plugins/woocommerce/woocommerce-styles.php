...
if ( ! function_exists( 'blabber_woocommerce_get_css' ) ) {
	add_filter( 'blabber_filter_get_css', 'blabber_woocommerce_get_css', 10, 2 );
	function blabber_woocommerce_get_css( $css, $args ) {
...
.widget_price_filter .price_slider_wrapper .ui-widget-content { 
	background: {$colors['text_light_03']};
}
