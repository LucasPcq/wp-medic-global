...
if ( ! function_exists( 'blabber_trx_addons_add_theme_vars' ) ) {
	add_filter( 'blabber_filter_add_theme_vars', 'blabber_trx_addons_add_theme_vars', 10, 2 );
	function blabber_trx_addons_add_theme_vars( $rez, $vars ) {
...
if ( ! function_exists( 'blabber_trx_addons_get_css' ) ) {
	add_filter( 'blabber_filter_get_css', 'blabber_trx_addons_get_css', 10, 2 );
	function blabber_trx_addons_get_css( $css, $args ) {
