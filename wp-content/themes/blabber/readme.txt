== Blabber ==
Version: 1.0
Copyright: 2019, AncoraThemes
WordPress version: required at least 4.5, tested up to 4.9 - 5.1
...
Please install and activate it before starting to use the theme Blabber.
...
Theme documentation is available on http://blabber.ancorathemes.com/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in Blabber is Fontello.
