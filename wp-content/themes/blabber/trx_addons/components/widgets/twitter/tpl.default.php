...
if (!empty($widget_args['columns_tablet'])) $widget_args['columns_tablet'] = max(1, min(12, (int) $widget_args['columns_tablet']));
if (!empty($widget_args['columns_mobile'])) $widget_args['columns_mobile'] = max(1, min(12, (int) $widget_args['columns_mobile']));
...
?><div class="widget_content">
    ...
    if ($follow) {
        ?><a href="<?php echo esc_url('//twitter.com/'.trim($twitter_username)); ?>" target="_blank" class="widget_twitter_follow"><?php esc_html_e('Follow us', 'blabber'); ?></a><?php
    }
