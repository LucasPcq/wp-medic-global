...
$trx_addons_output .= '<article class="post_item ' .($trx_addons_post_thumb ? 'with_thumb' : 'no_thumb').'">';

$trx_addons_output .= '<div class="post_thumb">' ;
if ($trx_addons_show_image) {
	if ($trx_addons_post_thumb)
		$trx_addons_output .= 		($trx_addons_post_link ? '<a href="' . esc_url($trx_addons_post_link) . '">' : '')
									. ($trx_addons_post_thumb) 
									. ($trx_addons_post_link ? '</a>' : '');
}
$trx_addons_output .= '</div>';
