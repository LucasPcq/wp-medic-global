...
if ( ! function_exists( 'overton_mikado_add_dripicons_icon_pack' ) ) {
	function overton_mikado_add_dripicons_icon_pack( $iconCollections ) {
		$iconCollections['dripicons'] = new OvertonMikadoClassDripicons( 'Dripicons', 'dripicon' );
		
		return $iconCollections;
	}
	
	add_filter( 'overton_mikado_filter_add_icon_pack_into_collection', 'overton_mikado_add_dripicons_icon_pack' );
}

if ( ! function_exists( 'overton_mikado_add_dripicons_icon_pack_option' ) ) {
	function overton_mikado_add_dripicons_icon_pack_option( $options ) {
		$options['dripicons'] = esc_html__( 'Dripicons', 'overton' );
		
		return $options;
	}
	
	add_filter( 'overton_mikado_filter_add_icon_pack_into_options', 'overton_mikado_add_dripicons_icon_pack_option' );
}

class OvertonMikadoClassDripicons implements iOvertonMikadoInterfaceIconCollection {
    public $icons;
    public $title;
    public $param;
    public $styleUrl;
