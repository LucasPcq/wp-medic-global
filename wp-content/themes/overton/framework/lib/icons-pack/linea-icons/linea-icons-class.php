...
if ( ! function_exists( 'overton_mikado_add_linea_icon_pack' ) ) {
	function overton_mikado_add_linea_icon_pack( $iconCollections ) {
		$iconCollections['linea_icons'] = new OvertonMikadoClassLineaIcons( 'Linea Icons', 'linea_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'overton_mikado_filter_add_icon_pack_into_collection', 'overton_mikado_add_linea_icon_pack' );
}

if ( ! function_exists( 'overton_mikado_add_linea_icon_pack_option' ) ) {
	function overton_mikado_add_linea_icon_pack_option( $options ) {
		$options['linea_icons'] = esc_html__( 'Linea Icons', 'overton' );
		
		return $options;
	}
	
	add_filter( 'overton_mikado_filter_add_icon_pack_into_options', 'overton_mikado_add_linea_icon_pack_option' );
}

class OvertonMikadoClassLineaIcons implements iOvertonMikadoInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
