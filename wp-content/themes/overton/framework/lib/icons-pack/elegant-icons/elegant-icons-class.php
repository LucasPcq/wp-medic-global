...
if ( ! function_exists( 'overton_mikado_add_font_elegant_icon_pack' ) ) {
	function overton_mikado_add_font_elegant_icon_pack( $iconCollections ) {
		$iconCollections['font_elegant'] = new OvertonMikadoClassIconsFontElegant( 'Font Elegant', 'fe_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'overton_mikado_filter_add_icon_pack_into_collection', 'overton_mikado_add_font_elegant_icon_pack' );
}

if ( ! function_exists( 'overton_mikado_add_font_elegant_icon_pack_option' ) ) {
	function overton_mikado_add_font_elegant_icon_pack_option( $options ) {
		$options['font_elegant'] = esc_html__( 'Font Elegant', 'overton' );
		
		return $options;
	}
	
	add_filter( 'overton_mikado_filter_add_icon_pack_into_options', 'overton_mikado_add_font_elegant_icon_pack_option' );
	add_filter( 'overton_mikado_filter_add_icon_pack_into_social_options', 'overton_mikado_add_font_elegant_icon_pack_option' );
}

class OvertonMikadoClassIconsFontElegant implements iOvertonMikadoInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
