...
if ( ! function_exists( 'overton_mikado_add_ion_icon_pack' ) ) {
	function overton_mikado_add_ion_icon_pack( $iconCollections ) {
		$iconCollections['ion_icons'] = new OvertonMikadoClassIonIcons( 'Ion Icons', 'ion_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'overton_mikado_filter_add_icon_pack_into_collection', 'overton_mikado_add_ion_icon_pack' );
}

if ( ! function_exists( 'overton_mikado_add_ion_icon_pack_option' ) ) {
	function overton_mikado_add_ion_icon_pack_option( $options ) {
		$options['ion_icons'] = esc_html__( 'Ion Icons', 'overton' );
		
		return $options;
	}
	
	add_filter( 'overton_mikado_filter_add_icon_pack_into_options', 'overton_mikado_add_ion_icon_pack_option' );
	add_filter( 'overton_mikado_filter_add_icon_pack_into_social_options', 'overton_mikado_add_ion_icon_pack_option' );
}

class OvertonMikadoClassIonIcons implements iOvertonMikadoInterfaceIconCollection {
	public $icons;
	public $socialIcons;
    public $title;
	public $param;
