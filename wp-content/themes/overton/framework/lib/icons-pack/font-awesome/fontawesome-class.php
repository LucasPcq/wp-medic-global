...
if ( ! function_exists( 'overton_mikado_add_font_awesome_icon_pack' ) ) {
	function overton_mikado_add_font_awesome_icon_pack( $iconCollections ) {
		$iconCollections['font_awesome'] = new OvertonMikadoClassIconsFontAwesome( 'Font Awesome', 'fa_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'overton_mikado_filter_add_icon_pack_into_collection', 'overton_mikado_add_font_awesome_icon_pack' );
}

if ( ! function_exists( 'overton_mikado_add_font_awesome_icon_pack_option' ) ) {
	function overton_mikado_add_font_awesome_icon_pack_option( $options ) {
		$options['font_awesome'] = esc_html__( 'Font Awesome', 'overton' );
		
		return $options;
	}
	
	add_filter( 'overton_mikado_filter_add_icon_pack_into_options', 'overton_mikado_add_font_awesome_icon_pack_option' );
	add_filter( 'overton_mikado_filter_add_icon_pack_into_social_options', 'overton_mikado_add_font_awesome_icon_pack_option' );
}

class OvertonMikadoClassIconsFontAwesome implements iOvertonMikadoInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
