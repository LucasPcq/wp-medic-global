...
if ( ! function_exists( 'overton_mikado_add_simple_line_icon_pack' ) ) {
	function overton_mikado_add_simple_line_icon_pack( $iconCollections ) {
		$iconCollections['simple_line_icons'] = new OvertonMikadoClassSimpleLineIcons( 'Simple Line Icons', 'simple_line_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'overton_mikado_filter_add_icon_pack_into_collection', 'overton_mikado_add_simple_line_icon_pack' );
}

if ( ! function_exists( 'overton_mikado_add_simple_line_icon_pack_option' ) ) {
	function overton_mikado_add_simple_line_icon_pack_option( $options ) {
		$options['simple_line_icons'] = esc_html__( 'Simple Line Icons', 'overton' );
		
		return $options;
	}
	
	add_filter( 'overton_mikado_filter_add_icon_pack_into_options', 'overton_mikado_add_simple_line_icon_pack_option' );
	add_filter( 'overton_mikado_filter_add_icon_pack_into_social_options', 'overton_mikado_add_simple_line_icon_pack_option' );
}

class OvertonMikadoClassSimpleLineIcons implements iOvertonMikadoInterfaceIconCollection {
    public $icons;
    public $title;
    public $param;
    public $styleUrl;
    ...
    public function setSocialIconsArray() {
        $this->socialIcons = array(
            ''                        => '',
            'icon-social-behance'     => esc_html__('Behance', 'overton'),
            'icon-social-dribbble'    => esc_html__('Dribbble', 'overton'),
            'icon-social-dropbox'     => esc_html__('Dropbox', 'overton'),
            'icon-social-facebook'    => esc_html__('Facebook', 'overton'),
            'icon-social-foursquare'  => esc_html__('Foursquare', 'overton'),
            'icon-social-github'      => esc_html__('Github', 'overton'),
            'icon-social-gplus'       => esc_html__('Google Plus', 'overton'),
            'icon-social-instagram'   => esc_html__('Instagram', 'overton'),
            'icon-social-linkedin'    => esc_html__('LinkedIn', 'overton'),
            'icon-social-pintarest'   => esc_html__('Pinterest', 'overton'),
            'icon-social-reddit'      => esc_html__('Reddit', 'overton'),
            'icon-social-skype'       => esc_html__('Skype', 'overton'),
            'icon-social-soundcloud'  => esc_html__('Soundcloud', 'overton'),
            'icon-social-stumbleupon' => esc_html__('Stumbleupon', 'overton'),
            'icon-social-spotify'     => esc_html__('Spotify', 'overton'),
            'icon-social-tumblr'      => esc_html__('Tumblr', 'overton'),
            'icon-social-twitter'     => esc_html__('Twitter', 'overton'),
            'icon-social-youtube'     => esc_html__('Youtube', 'overton')
        );
    }
