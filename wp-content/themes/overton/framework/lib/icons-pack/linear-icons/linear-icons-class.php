...
if ( ! function_exists( 'overton_mikado_add_linear_icon_pack' ) ) {
	function overton_mikado_add_linear_icon_pack( $iconCollections ) {
		$iconCollections['linear_icons'] = new OvertonMikadoClassLinearIcons( 'Linear Icons', 'linear_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'overton_mikado_filter_add_icon_pack_into_collection', 'overton_mikado_add_linear_icon_pack' );
}

if ( ! function_exists( 'overton_mikado_add_linear_icon_pack_option' ) ) {
	function overton_mikado_add_linear_icon_pack_option( $options ) {
		$options['linear_icons'] = esc_html__( 'Linear Icons', 'overton' );
		
		return $options;
	}
	
	add_filter( 'overton_mikado_filter_add_icon_pack_into_options', 'overton_mikado_add_linear_icon_pack_option' );
}

class OvertonMikadoClassLinearIcons implements iOvertonMikadoInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
