...
if ( ! function_exists( 'overton_mikado_fonts_options_map' ) ) {
	/**
	 * Font options page
	 */
	function overton_mikado_fonts_options_map() {
		
		overton_mikado_add_admin_page(
			array(
				'slug'  => '_fonts_page',
				'title' => esc_html__( 'Fonts', 'overton' ),
				'icon'  => 'fa fa-font'
			)
		);
		 ...
		 * Headings
		 */
		$panel_headings = overton_mikado_add_admin_panel(
			array(
				'page'  => '_fonts_page',
				'name'  => 'panel_headings',
				'title' => esc_html__( 'Headings', 'overton' )
			)
		);
		
		//H1
		$group_heading_h1 = overton_mikado_add_admin_group(
			array(
				'name'        => 'group_heading_h1',
				'title'       => esc_html__( 'H1 Style', 'overton' ),
				'description' => esc_html__( 'Define styles for h1 heading', 'overton' ),
				'parent'      => $panel_headings
			)
		);
		
		$row_heading_h1_1 = overton_mikado_add_admin_row(
			array(
		...
		overton_mikado_add_admin_field(
			array(
				...
				'args'          => array(
					'suffix' => esc_html__( 'px / em', 'overton' )
				),
				'parent'        => $row_heading_h1_1
			)
		);
		...
		$row_heading_h1_2 = overton_mikado_add_admin_row(
			array(
		...
		$row_heading_h1_3 = overton_mikado_add_admin_row(
			array(
		...
		overton_mikado_add_admin_field(
			array(
				...
				'name'          => 'h1_margin_top',
				'default_value' => '',
				'label'         => esc_html__( 'Margin Top (px)', 'overton' ),
		...
		overton_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Margin Bottom (px)', 'overton' ),
				'parent'        => $row_heading_h1_3
			)
		);
		
		//H2
		$group_heading_h2 = overton_mikado_add_admin_group(
			array(
				'name'        => 'group_heading_h2',
				'title'       => esc_html__( 'H2 Style', 'overton' ),
				'description' => esc_html__( 'Define styles for h2 heading', 'overton' ),
				'parent'      => $panel_headings
			)
		);
		
		$row_heading_h2_1 = overton_mikado_add_admin_row(
			array(
		...
		$row_heading_h2_2 = overton_mikado_add_admin_row(
			array(
		...
		$row_heading_h2_3 = overton_mikado_add_admin_row(
			array(
		...
		//H3
		$group_heading_h3 = overton_mikado_add_admin_group(
			array(
				'name'        => 'group_heading_h3',
				'title'       => esc_html__( 'H3 Style', 'overton' ),
				'description' => esc_html__( 'Define styles for h3 heading', 'overton' ),
				'parent'      => $panel_headings
			)
		);
		
		$row_heading_h3_1 = overton_mikado_add_admin_row(
			array(
		...
		$row_heading_h3_2 = overton_mikado_add_admin_row(
			array(
		...
		$row_heading_h3_3 = overton_mikado_add_admin_row(
			array(
		...
		//H4
		$group_heading_h4 = overton_mikado_add_admin_group(
			array(
				'name'        => 'group_heading_h4',
				'title'       => esc_html__( 'H4 Style', 'overton' ),
				'description' => esc_html__( 'Define styles for h4 heading', 'overton' ),
				'parent'      => $panel_headings
			)
		);
		
		$row_heading_h4_1 = overton_mikado_add_admin_row(
			array(
		...
		$row_heading_h4_2 = overton_mikado_add_admin_row(
			array(
		...
		$row_heading_h4_3 = overton_mikado_add_admin_row(
			array(
		...
		//H5
		$group_heading_h5 = overton_mikado_add_admin_group(
			array(
				'name'        => 'group_heading_h5',
				'title'       => esc_html__( 'H5 Style', 'overton' ),
				'description' => esc_html__( 'Define styles for h5 heading', 'overton' ),
				'parent'      => $panel_headings
			)
		);
		
		$row_heading_h5_1 = overton_mikado_add_admin_row(
			array(
		...
		$row_heading_h5_2 = overton_mikado_add_admin_row(
			array(
		...
		$row_heading_h5_3 = overton_mikado_add_admin_row(
			array(
		...
		//H6
		$group_heading_h6 = overton_mikado_add_admin_group(
			array(
				'name'        => 'group_heading_h6',
				'title'       => esc_html__( 'H6 Style', 'overton' ),
				'description' => esc_html__( 'Define styles for h6 heading', 'overton' ),
				'parent'      => $panel_headings
			)
		);
		
		$row_heading_h6_1 = overton_mikado_add_admin_row(
			array(
		...
		$row_heading_h6_2 = overton_mikado_add_admin_row(
			array(
		...
		$row_heading_h6_3 = overton_mikado_add_admin_row(
			array(
		 ...
		 */
		$panel_responsive_headings3 = overton_mikado_add_admin_panel(
			array(
				'page'  => '_fonts_page',
				'name'  => 'panel_responsive_headings3',
				'title' => esc_html__( 'Headings Responsive (Tablet Landscape View)', 'overton' )
			)
		);
		
		//H1
		$group_responsive3_heading_h1 = overton_mikado_add_admin_group(
			array(
				'name'        => 'group_responsive3_heading_h1',
				'title'       => esc_html__( 'H1 Responsive Style', 'overton' ),
				'description' => esc_html__( 'Define responsive styles for h1 heading', 'overton' ),
				'parent'      => $panel_responsive_headings3
			)
		);
		
		$row_responsive_heading_h1_3 = overton_mikado_add_admin_row(
			array(
		...
		//H2
		$group_responsive3_heading_h2 = overton_mikado_add_admin_group(
			array(
				'name'        => 'group_responsive3_heading_h2',
				'title'       => esc_html__( 'H2 Responsive Style', 'overton' ),
				'description' => esc_html__( 'Define responsive styles for h2 heading', 'overton' ),
				'parent'      => $panel_responsive_headings3
			)
		);
		
		$row_responsive_heading_h2_3 = overton_mikado_add_admin_row(
			array(
		...
		//H3
		$group_responsive3_heading_h3 = overton_mikado_add_admin_group(
			array(
				'name'        => 'group_responsive3_heading_h3',
				'title'       => esc_html__( 'H3 Responsive Style', 'overton' ),
				'description' => esc_html__( 'Define responsive styles for h3 heading', 'overton' ),
				'parent'      => $panel_responsive_headings3
			)
		);
		
		$row_responsive_heading_h3_3 = overton_mikado_add_admin_row(
			array(
		...
		//H4
		$group_responsive3_heading_h4 = overton_mikado_add_admin_group(
			array(
				'name'        => 'group_responsive3_heading_h4',
				'title'       => esc_html__( 'H4 Responsive Style', 'overton' ),
				'description' => esc_html__( 'Define responsive styles for h4 heading', 'overton' ),
				'parent'      => $panel_responsive_headings3
			)
		);
		
		$row_responsive_heading_h4_3 = overton_mikado_add_admin_row(
			array(
		...
		//H5
		$group_responsive3_heading_h5 = overton_mikado_add_admin_group(
			array(
				'name'        => 'group_responsive3_heading_h5',
				'title'       => esc_html__( 'H5 Responsive Style', 'overton' ),
				'description' => esc_html__( 'Define responsive styles for h5 heading', 'overton' ),
				'parent'      => $panel_responsive_headings3
			)
		);
		
		$row_responsive_heading_h5_3 = overton_mikado_add_admin_row(
			array(
		...
		//H6
		$group_responsive3_heading_h6 = overton_mikado_add_admin_group(
			array(
				'name'        => 'group_responsive3_heading_h6',
				'title'       => esc_html__( 'H6 Responsive Style', 'overton' ),
				'description' => esc_html__( 'Define responsive styles for h6 heading', 'overton' ),
				'parent'      => $panel_responsive_headings3
			)
		);
		
		$row_responsive_heading_h6_3 = overton_mikado_add_admin_row(
			array(
		 ...
		 */
		$panel_responsive_headings = overton_mikado_add_admin_panel(
			array(
				'page'  => '_fonts_page',
				'name'  => 'panel_responsive_headings',
				'title' => esc_html__( 'Headings Responsive (Tablet Portrait View)', 'overton' )
			)
		);
		
		//H1
		$group_responsive_heading_h1 = overton_mikado_add_admin_group(
			array(
		...
		$row_responsive_heading_h1_1 = overton_mikado_add_admin_row(
			array(
		...
		//H2
		$group_responsive_heading_h2 = overton_mikado_add_admin_group(
			array(
		...
		$row_responsive_heading_h2_1 = overton_mikado_add_admin_row(
			array(
		...
		//H3
		$group_responsive_heading_h3 = overton_mikado_add_admin_group(
			array(
		...
		$row_responsive_heading_h3_1 = overton_mikado_add_admin_row(
			array(
		...
		//H4
		$group_responsive_heading_h4 = overton_mikado_add_admin_group(
			array(
		...
		$row_responsive_heading_h4_1 = overton_mikado_add_admin_row(
			array(
		...
		//H5
		$group_responsive_heading_h5 = overton_mikado_add_admin_group(
			array(
		...
		$row_responsive_heading_h5_1 = overton_mikado_add_admin_row(
			array(
		...
		//H6
		$group_responsive_heading_h6 = overton_mikado_add_admin_group(
			array(
		...
		$row_responsive_heading_h6_1 = overton_mikado_add_admin_row(
			array(
		 ...
		 */
		$panel_responsive_headings2 = overton_mikado_add_admin_panel(
			array(
				'page'  => '_fonts_page',
				'name'  => 'panel_responsive_headings2',
				'title' => esc_html__( 'Headings Responsive (Mobile Devices)', 'overton' )
			)
		);
		
		//H1
		$group_responsive2_heading_h1 = overton_mikado_add_admin_group(
			array(
		...
		$row_responsive2_heading_h1_1 = overton_mikado_add_admin_row(
			array(
		...
		//H2
		$group_responsive2_heading_h2 = overton_mikado_add_admin_group(
			array(
		...
		$row_responsive2_heading_h2_1 = overton_mikado_add_admin_row(
			array(
		...
		//H3
		$group_responsive2_heading_h3 = overton_mikado_add_admin_group(
			array(
		...
		$row_responsive2_heading_h3_1 = overton_mikado_add_admin_row(
			array(
		...
		//H4
		$group_responsive2_heading_h4 = overton_mikado_add_admin_group(
			array(
		...
		$row_responsive2_heading_h4_1 = overton_mikado_add_admin_row(
			array(
		...
		//H5
		$group_responsive2_heading_h5 = overton_mikado_add_admin_group(
			array(
		...
		$row_responsive2_heading_h5_1 = overton_mikado_add_admin_row(
			array(
		...
		//H6
		$group_responsive2_heading_h6 = overton_mikado_add_admin_group(
			array(
		...
		$row_responsive2_heading_h6_1 = overton_mikado_add_admin_row(
			array(
		 ...
		 * Text
		 */
		$panel_text = overton_mikado_add_admin_panel(
			array(
				'page'  => '_fonts_page',
				'name'  => 'panel_text',
		...
		$group_text = overton_mikado_add_admin_group(
			array(
				'name'        => 'group_text',
				'title'       => esc_html__( 'Paragraph', 'overton' ),
				'description' => esc_html__( 'Define styles for paragraph text', 'overton' ),
				'parent'      => $panel_text
			)
		);
		
		$row_text_1 = overton_mikado_add_admin_row(
			array(
				'name'   => 'row_text_1',
				'parent' => $group_text
			)
		...
		$row_text_2 = overton_mikado_add_admin_row(
			array(
				'name'   => 'row_text_2',
				'parent' => $group_text,
				'next'   => true
		...
		$row_text_3 = overton_mikado_add_admin_row(
			array(
				'name'   => 'row_text_3',
				'parent' => $group_text,
				'next'   => true
		...
		$group_text_res1 = overton_mikado_add_admin_group(
			array(
				'name'        => 'group_text_res1',
				'title'       => esc_html__( 'Paragraph Responsive (Tablet Portrait View)', 'overton' ),
				'description' => esc_html__( 'Define responsive styles for paragraph text for tablet devices - portrait view', 'overton' ),
				'parent'      => $panel_text
			)
		);
		
		$row_res_text_1 = overton_mikado_add_admin_row(
			array(
				'name'   => 'row_text_1',
		...
		$group_text_res2 = overton_mikado_add_admin_group(
			array(
				'name'        => 'group_text_res2',
				'title'       => esc_html__( 'Paragraph Responsive (Mobile Devices)', 'overton' ),
				'description' => esc_html__( 'Define responsive styles for paragraph text for mobile devices', 'overton' ),
				'parent'      => $panel_text
			)
		);
		
		$row_res_text_2 = overton_mikado_add_admin_row(
			array(
				'name'   => 'row_res_text_2',
		...
		$group_link = overton_mikado_add_admin_group(
			array(
				'name'        => 'group_link',
				'title'       => esc_html__( 'Links', 'overton' ),
				'description' => esc_html__( 'Define styles for link text', 'overton' ),
				'parent'      => $panel_text
			)
		);
		
		$row_link_1 = overton_mikado_add_admin_row(
			array(
				'name'   => 'row_link_1',
				'parent' => $group_link
			)
		...
		overton_mikado_add_admin_field(
			array(
				...
				'name'          => 'link_color',
				'default_value' => '',
				'label'         => esc_html__( 'Link Color', 'overton' ),
				'parent'        => $row_link_1
			)
		);
		...
		overton_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Hover Link Color', 'overton' ),
				'parent'        => $row_link_1
			)
		);
		
		$row_link_2 = overton_mikado_add_admin_row(
			array(
				'name'   => 'row_link_2',
				'parent' => $group_link,
				'next'   => true
		...
		overton_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Link Decoration', 'overton' ),
				'options'       => overton_mikado_get_text_decorations(),
				'parent'        => $row_link_2
			)
		);
		...
		overton_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Hovel Link Decoration', 'overton' ),
				'options'       => overton_mikado_get_text_decorations(),
				'parent'        => $row_link_2
			)
		);
	...
	add_action( 'overton_mikado_action_options_map', 'overton_mikado_fonts_options_map', overton_mikado_set_options_map_position( 'fonts' ) );
}