...
if ( ! function_exists( 'overton_mikado_get_hide_dep_for_header_vertical_menu_options' ) ) {
	function overton_mikado_get_hide_dep_for_header_vertical_menu_options() {
		$hide_dep_options = apply_filters( 'overton_mikado_filter_header_vertical_menu_hide_global_option', $hide_dep_options = array() );
		
		return $hide_dep_options;
	}
}

if ( ! function_exists( 'overton_mikado_header_vertical_navigation_options_map' ) ) {
	function overton_mikado_header_vertical_navigation_options_map() {
		$hide_dep_options = overton_mikado_get_hide_dep_for_header_vertical_menu_options();
		
		$panel_vertical_main_menu = overton_mikado_add_admin_panel(
			array(
				'title'           => esc_html__( 'Vertical Main Menu', 'overton' ),
		...
		$drop_down_group = overton_mikado_add_admin_group(
			array(
				...
				'description' => esc_html__( 'Set a style for dropdown menu', 'overton' )
			)
		);
		
		$vertical_drop_down_row1 = overton_mikado_add_admin_row(
			array(
		...
		overton_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Top Margin', 'overton' ),
				'args'          => array(
					'suffix' => 'px'
				),
		...
		overton_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Bottom Margin', 'overton' ),
				'args'          => array(
					'suffix' => 'px'
				),
				'parent'        => $vertical_drop_down_row1
		...
		overton_mikado_add_admin_field(
			array(
				...
				'default_value' => 'below',
				'label'         => esc_html__( 'Submenu Opening', 'overton' ),
				'options'		=> array(
					'below' => esc_html__('Below', 'overton'),
					'side' => esc_html__('On Side', 'overton'),
				),
				'parent'        => $panel_vertical_main_menu
			)
		);

		$group_vertical_first_level = overton_mikado_add_admin_group(
			array(
				'name'        => 'group_vertical_first_level',
				'title'       => esc_html__( '1st level', 'overton' ),
				'description' => esc_html__( 'Define styles for 1st level menu', 'overton' ),
				'parent'      => $panel_vertical_main_menu
			)
		);
		
		$row_vertical_first_level_1 = overton_mikado_add_admin_row(
			array(
		...
		$row_vertical_first_level_2 = overton_mikado_add_admin_row(
			array(
		...
		$row_vertical_first_level_3 = overton_mikado_add_admin_row(
			array(
		...
		$group_vertical_second_level = overton_mikado_add_admin_group(
			array(
				'name'        => 'group_vertical_second_level',
				'title'       => esc_html__( '2nd level', 'overton' ),
				'description' => esc_html__( 'Define styles for 2nd level menu', 'overton' ),
				'parent'      => $panel_vertical_main_menu
			)
		);
		
		$row_vertical_second_level_1 = overton_mikado_add_admin_row(
			array(
		...
		$row_vertical_second_level_2 = overton_mikado_add_admin_row(
			array(
		...
		$row_vertical_second_level_3 = overton_mikado_add_admin_row(
			array(
		...
		$group_vertical_third_level = overton_mikado_add_admin_group(
			array(
				'name'        => 'group_vertical_third_level',
				'title'       => esc_html__( '3rd level', 'overton' ),
				'description' => esc_html__( 'Define styles for 3rd level menu', 'overton' ),
				'parent'      => $panel_vertical_main_menu
			)
		);
		
		$row_vertical_third_level_1 = overton_mikado_add_admin_row(
			array(
		...
		$row_vertical_third_level_2 = overton_mikado_add_admin_row(
			array(
		...
		$row_vertical_third_level_3 = overton_mikado_add_admin_row(
			array(
	...
	add_action( 'overton_mikado_action_additional_header_main_navigation_options_map', 'overton_mikado_header_vertical_navigation_options_map', 10, 1 );
}