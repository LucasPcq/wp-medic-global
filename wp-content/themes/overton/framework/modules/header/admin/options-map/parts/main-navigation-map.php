...
if ( ! function_exists( 'overton_mikado_get_hide_dep_for_header_main_menu_options' ) ) {
	function overton_mikado_get_hide_dep_for_header_main_menu_options() {
		$hide_dep_options = apply_filters( 'overton_mikado_filter_header_main_menu_hide_global_option', $hide_dep_options = array() );
		
		return $hide_dep_options;
	}
}

if ( ! function_exists( 'overton_mikado_header_main_navigation_options_map' ) ) {
	function overton_mikado_header_main_navigation_options_map() {
		$hide_dep_options = overton_mikado_get_hide_dep_for_header_main_menu_options();
		
		$panel_main_menu = overton_mikado_add_admin_panel(
			array(
				'title'           => esc_html__( 'Main Menu', 'overton' ),
		...
		overton_mikado_add_admin_section_title(
			array(
				...
				'title'  => esc_html__( 'Main Menu General Settings', 'overton' )
			)
		);
		
		$drop_down_group = overton_mikado_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'drop_down_group',
				'title'       => esc_html__( 'Main Dropdown Menu', 'overton' ),
				'description' => esc_html__( 'Choose a color and transparency for the main menu background (0 = fully transparent, 1 = opaque)', 'overton' )
			)
		);
		
		$drop_down_row1 = overton_mikado_add_admin_row(
			array(
		...
		overton_mikado_add_admin_field(
			array(
				...
				'label'         => esc_html__( 'Main Dropdown Menu Appearance', 'overton' ),
				'description'   => esc_html__( 'Choose appearance for dropdown menu', 'overton' ),
				'options'       => array(
					'dropdown-default'        => esc_html__( 'Default', 'overton' ),
					'dropdown-animate-height' => esc_html__( 'Animate Height', 'overton' )
				)
			)
		);
		...
		$first_level_group = overton_mikado_add_admin_group(
			array(
				...
				'description' => esc_html__( 'Define styles for 1st level in Top Navigation Menu', 'overton' )
			)
		);
		...
		overton_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Light Menu Hover Text Color', 'overton' ),
			)
		);
		...
		overton_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Light Menu Active Text Color', 'overton' ),
			)
		);
		
		$first_level_row4 = overton_mikado_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		overton_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Dark Menu Hover Text Color', 'overton' ),
			)
		);
		...
		overton_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Dark Menu Active Text Color', 'overton' ),
			)
		);
		
		$first_level_row5 = overton_mikado_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		$first_level_row6 = overton_mikado_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		$first_level_row7 = overton_mikado_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		overton_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Left/Right', 'overton' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		overton_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Margin Left/Right', 'overton' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$second_level_group = overton_mikado_add_admin_group(
			array(
				...
				'title'       => esc_html__( '2nd Level Menu', 'overton' ),
				'description' => esc_html__( 'Define styles for 2nd level in Top Navigation Menu', 'overton' )
			)
		);
		...
		overton_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Hover/Active Color', 'overton' )
			)
		);
		...
		$second_level_wide_group = overton_mikado_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'second_level_wide_group',
				'title'       => esc_html__( '2nd Level Wide Menu', 'overton' ),
				'description' => esc_html__( 'Define styles for 2nd level in Wide Menu', 'overton' )
			)
		);
		
		$second_level_wide_row1 = overton_mikado_add_admin_row(
			array(
		...
		$second_level_wide_row2 = overton_mikado_add_admin_row(
			array(
				'parent' => $second_level_wide_group,
		...
		$second_level_wide_row3 = overton_mikado_add_admin_row(
			array(
				'parent' => $second_level_wide_group,
		...
		$third_level_group = overton_mikado_add_admin_group(
			array(
				...
				'title'       => esc_html__( '3nd Level Menu', 'overton' ),
				'description' => esc_html__( 'Define styles for 3nd level in Top Navigation Menu', 'overton' )
			)
		);
		...
		$third_level_wide_group = overton_mikado_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'third_level_wide_group',
				'title'       => esc_html__( '3rd Level Wide Menu', 'overton' ),
				'description' => esc_html__( 'Define styles for 3rd level in Wide Menu', 'overton' )
			)
		);
		
		$third_level_wide_row1 = overton_mikado_add_admin_row(
			array(
		...
		$third_level_wide_row2 = overton_mikado_add_admin_row(
			array(
				'parent' => $third_level_wide_group,
		...
		$third_level_wide_row3 = overton_mikado_add_admin_row(
			array(
				'parent' => $third_level_wide_group,
	...
	add_action( 'overton_mikado_action_header_main_navigation_options_map', 'overton_mikado_header_main_navigation_options_map', 10, 1 );
}