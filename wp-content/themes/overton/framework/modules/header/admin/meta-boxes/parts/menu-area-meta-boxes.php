...
if ( ! function_exists( 'overton_mikado_get_hide_dep_for_header_menu_area_meta_boxes' ) ) {
	function overton_mikado_get_hide_dep_for_header_menu_area_meta_boxes() {
		$hide_dep_options = apply_filters( 'overton_mikado_filter_header_menu_area_hide_meta_boxes', $hide_dep_options = array() );
		
		return $hide_dep_options;
	}
}

if ( ! function_exists( 'overton_mikado_header_menu_area_meta_options_map' ) ) {
	function overton_mikado_header_menu_area_meta_options_map( $header_meta_box ) {
		$hide_dep_options = overton_mikado_get_hide_dep_for_header_menu_area_meta_boxes();
		...
		overton_mikado_create_meta_box_field(
			array(
				...
				'description' => esc_html__( 'Set grid background transparency for menu area (0 = fully transparent, 1 = opaque)', 'overton' ),
				'parent'      => $menu_area_in_grid_container,
				'args'        => array(
					'col_width' => 2
				)
		...
		overton_mikado_create_meta_box_field(
			array(
				...
				'description'   => esc_html__( 'Set shadow on grid menu area', 'overton' ),
				'parent'        => $menu_area_in_grid_container,
				'default_value' => '',
				'options'       => overton_mikado_get_yes_no_select_array()
			)
		...
		overton_mikado_create_meta_box_field(
			array(
				...
				'description'   => esc_html__( 'Set border on grid menu area', 'overton' ),
				'parent'        => $menu_area_in_grid_container,
				'default_value' => '',
				'options'       => overton_mikado_get_yes_no_select_array()
			)
		...
		overton_mikado_create_meta_box_field(
			array(
				...
				'description' => esc_html__( 'Choose a background color for menu area', 'overton' ),
				'parent'      => $menu_area_container
			)
		);
		...
		overton_mikado_create_meta_box_field(
			array(
				...
				'description' => esc_html__( 'Choose a transparency for the menu area background color (0 = fully transparent, 1 = opaque)', 'overton' ),
				'parent'      => $menu_area_container,
				'args'        => array(
					'col_width' => 2
				)
		...
		$menu_area_border_bottom_color_container = overton_mikado_add_admin_container(
			array(
				'type'            => 'container',
		...
		overton_mikado_create_meta_box_field(
			array(
				...
				'description' => esc_html__( 'Enter value in px or percentage to define menu area side padding', 'overton' ),
				'parent'      => $menu_area_container,
				'args'        => array(
					'col_width' => 3,
		...
		do_action( 'overton_mikado_header_menu_area_additional_meta_boxes_map', $menu_area_container );
	}
	
	add_action( 'overton_mikado_action_header_menu_area_meta_boxes_map', 'overton_mikado_header_menu_area_meta_options_map', 10, 1 );
}