...
if($display_button === 'yes') {
	...
	<div class="mkdf-pl-custom-atc-btn mkdf-<?php echo esc_attr($class_name); ?>-add-to-cart <?php echo esc_attr($buttonSkinClass); ?>">
		<?php echo apply_filters( 'overton_mikado_filter_product_list_add_to_cart_link',
			sprintf( '<a rel="nofollow" href="%s" data-quantity="%s" data-product_id="%s" data-product_sku="%s" class="%s">%s</a>',
				...
				wp_kses_post( overton_mikado_icon_collections()->renderIcon( "dripicons-cart", "dripicons" ) )
			),
			$product ); ?>
	</div>
<?php } ?>