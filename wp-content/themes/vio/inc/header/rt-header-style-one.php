...
<!-- wraper_header -->
<?php if ( true == vio_global_var( 'header_one_floating', '', false ) ) { ?>
	<header class="wraper_header style-one floating-header">
<?php } else { ?>
	<header class="wraper_header style-one static-header">
<?php } ?>
	<!-- wraper_header_main -->
	<?php if ( true == vio_global_var( 'header_one_sticky', '', false ) ) { ?>
	    <div data-delay="<?php echo esc_attr( vio_global_var( 'header_one_sticky_delay', '', false ) ); ?>" class="wraper_header_main radiantthemes-sticky-style-<?php echo esc_attr( vio_global_var( 'header_one_sticky_style', '', false ) ); ?>">
	<?php } else { ?>
		...
		<div class="container">
			...
			<div class="header_main">
				...
				<?php if ( true == vio_global_var( 'header_one_mobile_menu_display', '', false ) ) : ?>
					...
					<!-- header-responsive-nav -->
				<?php endif; ?>
				<?php if ( true == vio_global_var( 'header_one_hamburger_display', '', false ) ) : ?>
				    <!-- header-hamburger-menu -->
					<?php if ( true == vio_global_var( 'header_one_hamburger_mobile', '', false ) ) { ?>
				...
				<div class="header_main_action">
					<ul>
						<?php if ( ( class_exists( 'WooCommerce' ) ) && ( true == vio_global_var( 'header_one_cart_display', '', false ) ) ) : ?>
						...
						<?php endif; ?>
						<?php if ( true == vio_global_var( 'header_one_search_display', '', false ) ) : ?>
				...
				<nav class="nav visible-lg hidden-md hidden-sm hidden-xs">
					<?php
					if ( true == vio_global_var( 'header_one_menu_singlepagemode', '', false ) ) {
        				wp_nav_menu(
                            array(
                                'theme_location'    => 'top',
                                'fallback_cb'       => false,
	...
	<div class="mobile-menu hidden">
		...
		<div class="mobile-menu-main">
			...
			<div class="mobile-menu-close">
				<img src="/wp-content/themes/vio/inc/header/icons8-effacer.svg">
			</div>
			<!-- mobile-menu-close -->
			<!-- mobile-menu-nav -->
			<nav class="mobile-menu-nav">
				<?php if ( true == vio_global_var( 'header_one_menu_singlepagemode', '', false ) ) {
    				wp_nav_menu(
                        array(
                            'theme_location' => 'top',
                            'fallback_cb'       => false,
